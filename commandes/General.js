...
Aftab({ nomCom: "developer", categorie: "General", reaction: "💞" }, async (dest, zk, commandeOptions) => {
    const { ms, mybotpic } = commandeOptions;

    const devs = [
      { nom: "Aftab Abbasi", numero: "254757835036" },
      { nom: "᚛Aftab Abbasi᚜", numero: "254750948696" },
...
aftab({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
