...
aftab({ nomCom: "tempmail", reaction: "😌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
    console.log("Commande saisie !!!s");
    let z = '*AFTAB-ABBASI* Temporary emails,Powered by *AFTAB-ABBASI* \n\n ' + "Click the links below to create unlimited TEMPORARY Emails. Powered by *AFTAB-ABBASI.*\n\n";
